...
<div class="contact-wrapper">
  ...
  ?>
  <section id="contact" class="svg_enable" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -100px;" >
    <div class="container">
      <div class="page-contact">
        <?php if($heading!=''){ ?>
        <h2 class="cnt-main-heading"><?php echo esc_html($heading); ?></h2>
        <?php } else { ?>
        <h2 class="cnt-main-heading"><?php 
                if( shortcode_exists( 'themehunk-customizer-oneline-lite' ) ) {

        echo do_shortcode("[themehunk-customizer-oneline-lite did='333']"); ?></h2>
        <?php } } ?>
        <?php if($subheading!=''){ ?>
        <p class="cnt-sub-heading"><?php echo esc_html($subheading); ?></p>
        <?php } else {                 
          if( shortcode_exists( 'themehunk-customizer-oneline-lite' ) ) { ?>

        <p class="cnt-sub-heading"><?php echo do_shortcode("[themehunk-customizer-oneline-lite did='6']"); ?> </p>
        <?php } } ?>
